...
# ==========================================
# 4. Dataset (FloodDataset - Univariate)
# ==========================================
...
# ==========================================
# 5. Ingestion Support (CSV & Metadata)
# ==========================================
...
if __name__ == "__main__":
    ...
    # Note: train/evaluate functions are not fully defined in this snippet but ingestion is the priority
    # To fully support training, one would add the train/evaluate loops here.
    # For now, we prioritize the inference path for submission.